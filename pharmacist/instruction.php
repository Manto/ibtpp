...
<ol>
<li>BabyBIG<sup>&reg;</sup> should be given as soon after arrival at the pharmacy as can be arranged. Please refer to instructions in the <a href="/pharmacist/BabyBIG Hospital Packet January 2021_Final_ADA.pdf">information packet</a> that comes with the medicine.  A filter and tubing for administration are sent with the product.<br><br></li>
<li>Please plan in advance of its arrival with the patient's ICU/ward team so as to be ready to promptly rehydrate and administer the medicine when it reaches you.  This means having a secure IV placed and a syringe infusion pump already at the bedside. Please be sure to follow the instruction regarding <b>syringe size</b> per the filter Instructions For Use provided in the shipment <a href="/pharmacist/BabyBIG Hospital Packet January 2021_Final_ADA.pdf">information packet</a>.<br><br></li>
