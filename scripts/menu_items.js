...
var MENU_ITEMS = [
	...
	['For Physicians', null, null,
		['How&nbsp;to&nbsp;obtain&nbsp;Clinical&nbsp;Consultation&nbsp;and&nbsp;Order&nbsp;BabyBIG<sup>&reg;</sup>',SITE_ROOT + 'physician/obtain.php'],
		['Information for Clinicians', 'https://www.cdc.gov/botulism/hcp/clinical-overview/infant-botulism.html?CDC_AAref_Val=https://www.cdc.gov/botulism/infant-botulism.html'],
	...
	['Lab Testing Info',null, null,
		...
		['Specimen Submission (CA only)',SITE_ROOT + 'laboratorian/submission.php'],
                ['Specimen Submission form (CA only)',SITE_ROOT + 'laboratorian/IB%20Diagnostic%20Specimen%20Submission%20Form.pdf'],
		['Lab Scientist FAQs',SITE_ROOT + 'laboratorian/faq.php'],
		['Microbiology of <i>C. botulinum</i>',SITE_ROOT + 'laboratorian/microbiology.php'],
		['CLIA Certificate', 'https://www.cdph.ca.gov/Programs/CID/DCDC/CDPH%20Document%20Library/MDLCLIACertification2022to2024.pdf'],
	],
