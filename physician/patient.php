...
<p>
The live-virus vaccine for rotavirus, RotaTeq® and Rotatrix® should also be delayed until sustained return of normal bowel function after BabyBIG<sup>&reg;</sup> treatment. Although current data suggest that administration of intravenous immunoglobulin products such as BabyBIG<sup>&reg;</sup> will not interfere with the efficacy of oral rotavirus vaccines, patients with infant botulism should receive the rotavirus vaccine later than planned because of the slowed intestinal motility that results from infant botulism. The vast majority of infant botulism patients have profoundly slowed intestinal motility after infant botulism.
</p>
<p>
